...
<nav class="navbar" role="navigation" aria-label="main navigation">
	<div class="navbar-brand">
		<a class="navbar-item" href="/home" id="appname" on:click={hide}> De Mol '22 </a>
		...
		>
			<i class="fa fa-user-circle" on:click={handleMobileIconClick} />
		</a>
	</div>
			...
			{#if isLoggedIn}
				...
				<!-- <a class="navbar-link"> Statistieken </a>
					<div class="navbar-dropdown">
						<a class="navbar-item" on:click={hide} href="/insight/me"> Mijn inzet </a>
						<a class="navbar-item" on:click={hide} href="/insight"> Iedereen zijn inzet </a>
					</div> -->
				<!-- </div> -->
			{/if}
			<a class="navbar-item" on:click={hide} href="/info"> Info </a>
		</div>
